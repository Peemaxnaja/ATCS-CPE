...
"""
Load data from gun_q_a.txt and convert it into a list of dictionaries.
...
The category line may also carry a language register, e.g.
    [หมวด: ความปลอดภัยและการเก็บรักษา | ภาษา: แสลง]
so the same fact is stored several times worded differently. That lets the
retriever match a question no matter how formally the user phrases it.
