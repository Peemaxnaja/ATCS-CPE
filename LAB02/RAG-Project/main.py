...
Answer questions using only the `gun_q_a.txt` knowledge base (retrieval-based QA).
...
DISCLAIMER = (
    "For education only. Not legal advice for any specific case."
)
...
def main():
    ...
    print("--- RAG System for Firearms Law & Safety QA ---")
    ...
    while True:
        query = input("\nถามเรื่องปืน กฎหมาย หรือความปลอดภัยได้เลย: ").strip()
